...
The current supported version is **Font Awesome 5.15.2 Free**. Previous versions are available [here](https://github.com/ruedap/alfred-font-awesome-workflow/releases/latest).
