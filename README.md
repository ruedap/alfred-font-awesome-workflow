...
The current supported version is **Font Awesome 5.8.2 Free**. Previous versions are available [here](https://github.com/ruedap/alfred-font-awesome-workflow/releases).
